...
const List = () => {
  ...
  const fetchDocuments = async () => {
    try {
      const response = await axios.get("https://police-website-frontend.vercel.app/documents");
  ...
  const deleteDocument = async (id) => {
    try {
      await axios.delete(`https://police-website-frontend.vercel.app/documents/${id}`);
  ...
  const addDocument = async () => {
    try {
      const response = await axios.post("https://police-website-frontend.vercel.app/documents", newDocument);
